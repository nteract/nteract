...
export interface SyncableHandle {
  ...
  init_comments_sync_target?(commentsDocId: string, commentsAuthorityActorLabel: string): void;

  /** Create a pending local comment thread. */
  ...
  /** Add a pending local reply to a comment thread. */
