...
class PyQueueEntry:
    ...
    def cell_id(self) -> str | None:
        """Cell ID when this entry came from a cell-scoped response."""
        ...
...
class ExecutionViewUpsert:
    """Execution upsert from the shared execution materialized view."""

    @property
    def execution_id(self) -> str: ...
    @property
    def snapshot(self) -> ExecutionViewSnapshot: ...

class NotebookQueueProjection:
    """Notebook-specific queue join layered on top of execution-id queue state."""

    @property
    def executing_cell_id(self) -> str | None: ...
    @property
    def queued_cell_ids(self) -> list[str]: ...

class ExecutionQueueProjection:
    ...
    @property
    def notebook(self) -> NotebookQueueProjection | None: ...

class ExecutionViewChangeset:
    """Shared execution materialized-view changeset."""

    @property
    def cell_pointer_changes(self) -> list[CellExecutionPointer]: ...
    @property
    def execution_upserts(self) -> list[ExecutionViewUpsert]: ...
    @property
    def removed_execution_ids(self) -> list[str]: ...
    @property
    def queue(self) -> ExecutionQueueProjection | None: ...
...
class AsyncSession:
    ...
    def get_execution_view_sync(self) -> ExecutionViewChangeset: ...
