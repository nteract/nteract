...
export type EnvironmentIconProps = SVGProps<SVGSVGElement>;

/** Deno logo icon. */
export function DenoIcon({ className, ...props }: EnvironmentIconProps) {
  return (
    <svg
...
/** Python logo icon. */
export function PythonIcon({ className, ...props }: EnvironmentIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
/** uv logo icon. */
export function UvIcon({ className, ...props }: EnvironmentIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 41 41"
...
/** Conda logo icon. */
export function CondaIcon({ className, ...props }: EnvironmentIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
...
/** Prefix/Pixi logo icon. */
export function PixiIcon({ className, ...props }: EnvironmentIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
