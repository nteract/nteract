...
export interface NotebookEnvironmentSummaryProps extends EnvironmentSummaryProps {}

export function NotebookEnvironmentSummary(props: NotebookEnvironmentSummaryProps) {
  return <EnvironmentSummary {...props} />;
}
