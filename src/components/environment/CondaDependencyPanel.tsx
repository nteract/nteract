...
import type { EnvProgressState, EnvironmentYmlDeps, EnvironmentYmlInfo } from "runtimed";
...
export interface CondaDependencyPanelProps {
  dependencies: string[];
  channels: string[];
  python: string | null;
  loading: boolean;
...
export function CondaDependencyPanel({
  dependencies,
  channels,
  python,
  loading,
