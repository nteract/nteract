...
import type {
  DenoConfigInfo,
  DependencyPanelVariant,
  EnvironmentSyncState,
} from "./dependency-panel-types";

export type { DenoConfigInfo };

export interface DenoDependencyPanelProps {
...
export function DenoDependencyPanel({
  denoConfigInfo,
  flexibleNpmImports,
