 ...
 */
export function setExecution(execution_id: string, snap: ExecutionSnapshot): void {
 ...
 */
export function setCellExecutionPointer(cell_id: string, execution_id: string | null): void {
...
export function getExecutionById(execution_id: string): ExecutionSnapshot | undefined {
