...
const families = [
  ...
  },
  {
    ...
    status: "active",
    intent:
      "WidgetView, WidgetStore, AnyWidgetView, the AFM model proxy, inline and URL-backed anywidget assets, the current built-in controls registry, form, selection, numeric, status, media, hydrated DataView image buffers, docs-local bufferPaths URL hydration, file upload, OutputModel with nested widget-view output and local replay, layout containers, ControllerModel polling against a fixture Gamepad API, ipycanvas CanvasModel command replay and image_data restore, unsupported fallback, and static snapshots now render from comm-state fixtures.",
  },
  {
