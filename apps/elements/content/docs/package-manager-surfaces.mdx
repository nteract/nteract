...
description: Fixture-backed package summaries and manager panels from the notebook app.
---
...
affordance. This page renders shared package summaries plus manager-specific
fixtures without a live daemon, Automerge document, or environment solve.
...
- The catalog uses `NotebookPackageSummaryPanel` for uv/package rail review; the
  older uv management control is intentionally absent from this page.
