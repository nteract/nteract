...
now has a docs-owned static WASM asset, and the Arrow stream manifest path now
runs through a docs-served Arrow IPC chunk. The widget catalog covers local
