...
output-widget routing, live controller/gamepad input, anywidget ESM loading, and
generated WASM handoffs remain explicit adapter boundaries for later catalog
slices.
