...
/**
 * Floating comment composer anchored to a text selection, opened from the
 * editor's "Comment" affordance. Creates the thread in place instead of routing
 * the author to the comments rail.
 */
export function InlineCommentComposer({
  ...
  const submit = async () => {
    ...
    try {
      ...
      // Keep the composer open so the author can retry without losing text.
      setSubmitting(false);
    }
  };
