...
export function useTrust() {
  ...
  const trustInfo: TrustInfo | null = useMemo(() => {
    ...
    return {
      ...
      approved_conda_channels: runtimeState.trust.approved_conda_channels,
      ...
      approved_pixi_channels: runtimeState.trust.approved_pixi_channels,
    };
  }, [
    runtimeLoaded,
