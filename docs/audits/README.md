...
Audits are source-backed evidence and follow-up lists for a boundary,
subsystem, or product surface. They are not decision-authoritative on their own;
durable decisions should graduate into ADRs, and product requirements should
graduate into PRDs.
