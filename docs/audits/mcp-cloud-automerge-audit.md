...
|---|---|---|
| MCP clients | Separate MCP processes can share a daemon and notebook room. Each child serves one stdio connection. | Concurrent requests on that connection share its active notebook; they are not independently scoped clients. See [the entrypoint](https://github.com/nteract/nteract/blob/6bff3e7b0a6e27b89c9ee3e700c6e7ffd6100885/crates/runt/src/main.rs#L739) and [session state](https://github.com/nteract/nteract/blob/6bff3e7b0a6e27b89c9ee3e700c6e7ffd6100885/crates/runt-mcp/src/lib.rs#L119). |
