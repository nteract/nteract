...
| Cloud-connected local clients and Desktop bridging | [`adr/cloud-connected-local-mcp.md`](adr/cloud-connected-local-mcp.md), [`memos/desktop-cloud-daemon-bridge.md`](memos/desktop-cloud-daemon-bridge.md) |
