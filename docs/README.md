...
| Self-hosted and on-prem deployment | [`memos/self-hosted-celld.md`](memos/self-hosted-celld.md), [`memos/aws-rust-room-host.md`](memos/aws-rust-room-host.md), [`adr/deployment-topology.md`](adr/deployment-topology.md), [`adr/remote-workstation-doc-agents.md`](adr/remote-workstation-doc-agents.md) |
