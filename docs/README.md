...
| Portable hosted room substrate | [`audits/notebook-cloud-host-compatibility.md`](audits/notebook-cloud-host-compatibility.md), [`memos/notebook-room-host-selection.md`](memos/notebook-room-host-selection.md), [`memos/aws-rust-room-host.md`](memos/aws-rust-room-host.md) |
