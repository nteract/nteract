...
| Execution and output transport | [`adr/execution-pipeline.md`](adr/execution-pipeline.md), [`memos/execution-engines-and-marimo.md`](memos/execution-engines-and-marimo.md), [`adr/typed-frame-v4-wire-protocol.md`](adr/typed-frame-v4-wire-protocol.md), [`adr/blob-ref-and-chunk-manifest-protocol.md`](adr/blob-ref-and-chunk-manifest-protocol.md), [`memos/arrow-bounded-head-and-progressive-fetch.md`](memos/arrow-bounded-head-and-progressive-fetch.md), [`memos/large-cell-payloads.md`](memos/large-cell-payloads.md) |
