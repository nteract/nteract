...
| Hosted accounts, Notebook Home, and compute federation | [`memos/hosted-notebook-federation.md`](memos/hosted-notebook-federation.md), [`memos/desktop-cloud-daemon-bridge.md`](memos/desktop-cloud-daemon-bridge.md), [`adr/remote-workstation-doc-agents.md`](adr/remote-workstation-doc-agents.md) |
