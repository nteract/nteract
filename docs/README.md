...
| Notebook shell, frontend convergence, external hosts, and RxJS stores | [`adr/notebook-host-shell-convergence.md`](adr/notebook-host-shell-convergence.md), [`memos/host-neutral-notebook-web-artifacts.md`](memos/host-neutral-notebook-web-artifacts.md), [`adr/frontend-sync-bridge.md`](adr/frontend-sync-bridge.md), [`memos/shared-store-projection-convergence.md`](memos/shared-store-projection-convergence.md), [`adr/output-rendering-segmentation.md`](adr/output-rendering-segmentation.md) |
