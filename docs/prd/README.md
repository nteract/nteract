...
Product requirements describe user-facing behavior, workflows, roles, launch
criteria, and product constraints. They can cite ADRs, but they should not
silently make low-level transport, storage, or security decisions.
