...
- `docs/architecture/execution-pipeline.md` — the seven invariants behind cell execution.
- `docs/architecture/three-document-split.md` — `RuntimeStateDoc` as the durable record.
- `docs/architecture/identity-and-trust.md` — who is allowed to interrupt or restart.
- `docs/architecture/cleanup-punchlist.md` — EP-3 row links here.
