...
pub fn install_mcpb(app: &tauri::AppHandle) -> Result<PathBuf, String> {
    ...
    let manifest = serde_json::json!({
        ...
        "tools": [
            ...
            { "name": "create_cell", "description": "Create a cell, optionally executing it and returning execution_id/output summary." },
            { "name": "set_cell", "description": "Replace a cell's source or type, optionally executing it and returning execution_id/output summary." },
            { "name": "delete_cell", "description": "Delete a cell." },
            { "name": "move_cell", "description": "Move a cell to a new position." },
            { "name": "execute_cell", "description": "Execute a code cell and return execution_id, status, and compact output summary." },
